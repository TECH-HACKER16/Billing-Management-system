...
public class DeleteProduct extends JFrame implements ActionListener {
    ...
    JTextField productIdField, productNameField, rateField, descriptionField, activateField;
    ...
    DeleteProduct() {
        ...
        // Heading
        heading = new JLabel("Delete Product");
        heading.setBounds(200, 10, 160, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            ...
            try {
                CONN c = new CONN();
                int response = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this product?");
